...
class ActiviteitRepository extends \Doctrine\ORM\EntityRepository
{
    public function getBeschikbareActiviteiten($userid)
    {
        ...
        $query=$em->createQuery("SELECT a FROM AppBundle\Entity\Activiteit a WHERE :userid NOT MEMBER OF a.users AND :date < a.datum ORDER BY a.datum");
    ...
    public function getIngeschrevenActiviteiten($userid)
    {
        ...
        $em=$this->getEntityManager();
        $query=$em->createQuery("SELECT a FROM AppBundle\Entity\Activiteit a WHERE :userid MEMBER OF a.users ORDER BY a.datum");
